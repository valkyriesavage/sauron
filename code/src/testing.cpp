...
//--------------------------------------------------------------
void testing::keyPressed(int key){
...
//--------------------------------------------------------------
void testing::keyReleased(int key){

}

//--------------------------------------------------------------
void testing::mouseMoved(int x, int y ){

}

//--------------------------------------------------------------
void testing::mouseDragged(int x, int y, int button){

}

//--------------------------------------------------------------
void testing::mousePressed(int x, int y, int button){

}

//--------------------------------------------------------------
void testing::mouseReleased(int x, int y, int button){

}

//--------------------------------------------------------------
void testing::windowResized(int w, int h){

}

//--------------------------------------------------------------
void testing::gotMessage(ofMessage msg){

}

//--------------------------------------------------------------
void testing::dragEvent(ofDragInfo dragInfo){ 
